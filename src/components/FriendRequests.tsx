...
export const FriendRequests: FC<FriendRequestsProps> = ({ onClick, count }) => {
  ...
  return (
    ...
    >
      ...
      >
        Friend requests
        {count > 0 && <span className="absolute w-4 h-4 bg-indigo-600 rounded-full right-[-1rem] top-0 text-center justify-items-center text-xs text-white center">
          {count}
        </span>}
      </p>
    </button>
